...
machine = 'server'; % 'private'; %

% Load data from pre-computed source
if strcmp(machine, 'server')
    path_data = '/space/syn09/1/data/MMILDB/fabian/ErrorFields/isoL505030nsim12000n1_gauss_stddev7.mat';
    %path_data = '/space/syn09/1/data/MMILDB/fabian/ErrorFields/isoL505030nsim1n12000_gauss_stddev5.mat';
    cd ~/PeakDetection/simulations/
else
    path_data = 'C:\Users\ftelschow\Documents\Linux\Research\MatlabCode\PeakDetection\data\isoL505030nsim12000n1_gauss_stddev7.mat';
    path_data = 'C:\Users\ftelschow\Documents\Linux\Research\MatlabCode\PeakDetection\data\isoL505030nsim1n5000_gauss_stddev5.mat';
