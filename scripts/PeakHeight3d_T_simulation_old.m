...
if ~strcmp(machine,'server')
    ...
    file ='FieldTYPE_T_N200Msim100000_isotropicGauss777kappa1_prethresh2.5_transform1';% output_name;
    ...
    FieldTYPE = 'T2Z'; % 'T'; % 'T2Z'; % choose 'T2Z' if transform1==1
